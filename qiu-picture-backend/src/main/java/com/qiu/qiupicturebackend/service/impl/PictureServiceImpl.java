...
import com.qiu.qiupicturebackend.asset.application.AssetVersionSyncApplicationService;
...
import com.qiu.qiupicturebackend.manager.CosManager;
import com.qiu.qiupicturebackend.manager.FileManager;
import com.qiu.qiupicturebackend.manager.upload.FilePictureUpload;
import com.qiu.qiupicturebackend.manager.upload.PictureUploadTemplate;
import com.qiu.qiupicturebackend.manager.upload.UrlPictureUpload;
import com.qiu.qiupicturebackend.mapper.PictureMapper;
import com.qiu.qiupicturebackend.model.dto.file.UploadPictureResult;
import com.qiu.qiupicturebackend.model.dto.picture.*;
...
import com.qiu.qiupicturebackend.utils.ColorSimilarUtils;
...
/**
 * @author 19365
 * @description 针对表【picture(图片)】的数据库操作作Service实现
 * @createDate 2026-04-20 16:45:57
 */
@Slf4j
@Service
public class PictureServiceImpl extends ServiceImpl<PictureMapper, Picture>
    ...
    @Resource
    private UrlPictureUpload urlFilePictureUpload;
    @Resource
    ...
    @Resource
    private AssetVersionSyncApplicationService assetVersionSyncApplicationService;
    ...
    public PictureVO uploadPicture(Object inputSource, PictureUploadRequest pictureUploadRequest, User loginUser) {
        ...
        transactionTemplate.execute(status -> {
            ...
            ThrowUtils.throwIf(!result, ErrorCode.OPERATION_ERROR, "图片上传失败，数据库操作作失败");
            //更新空间使用额度度
            boolean update = spaceService.lambdaUpdate()
                    ...
                    .update();
            ThrowUtils.throwIf(!result, ErrorCode.OPERATION_ERROR, "额度更新失败");
            return picture;
        ...
        // 异步同步初始版本记录（不阻塞上传响应）
        if (pictureId == null) {
            assetVersionSyncApplicationService.syncInitialVersion(picture);
        }
    ...
    public Integer uploadPictureByBatch(PictureUploadByBatchRequest pictureUploadByBatchRequest, User loginUser) {
        ...
        for (Element imgElement : imgElementList) {
            ...
            try {
                ...
                log.info("上传图片片成功, id = {}", pictureVO.getId());
                uploadCount++;
            } catch (Exception e) {
                log.error("上传图片片失败", e);
                continue;
    ...
    public void clearPictureFile(Picture oldPicture) {
        ...
        // FIXME 注意将，这里的 url 包含了域名，实际上只要传 key 值（存储路径）就够了
    ...
    public List<PictureVO> searchPictureByColor(Long spaceId, String picColor, User loginUser) {
        ...
        List<Picture> sortedPictureList = pictureList.stream()
                .sorted(Comparator.comparingDouble(picture -> {
                    ...
                    Color piutureColor = Color.decode(hexColor);
                    //计算相似度
                    return -ColorSimilarUtils.calculateSimilarity(targetColor, piutureColor);
                }))
                .limit(12)
